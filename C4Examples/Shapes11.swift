...
class Shapes11: CanvasController {
    ...
    func createAndStylePolygons() {
        ...
        let polyPoints = [Point(),Point(150, Int(-height)),Point(300, 0)]
        
        //create poly1 and style it
        poly1 = Polygon(polyPoints)
        poly1.fillColor = Color(UIColor.clearColor())
        poly1.lineWidth = 30.0
        poly1.center = Point(self.canvas.center.x, self.canvas.height/4)
        ...
        poly3.center = Point(self.canvas.center.x, self.canvas.height*3/4);
